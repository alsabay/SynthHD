---
title: "Synthesized_Full_Cleveland_Data"
author: "Al Sabay"
date: "6/28/2018"
output: pdf_document
---
...
# recode diagnosis (num) to 1 (from 1,2,3,4) if heart disease exists, or 0 if no heart disease exists.
...
## Full Cleveland Dataset Synthesis
The original "cleveland.data"  dataset from the UCI Repository http://archive.ics.uci.edu/ml/machine-learning-databases/heart-disease/cleveland.data, 
was prepared and used to synthesize 60K records (from the original 282 records) of anonymized data for use in Artificial Neural Network Models. 

Below are the comparison charts that show the synthesized data having the same distribution and percentages as the original seed data.

## Comparison Plots

These plots compare the % of the original Cleveland dataset to the Synthesized dataset. Note that "num" is the diagnosis variable.
...
compare(syn_cleve, df_new, vars = "laddist")
